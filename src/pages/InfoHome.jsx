...
const ImageWithOverlay = ({ src, alt, title, direction }) => (
  <motion.div
    ...
    className="group w-full max-w-[34rem]"
  >
    <div className="relative aspect-[5/4] overflow-hidden rounded-lg">
      <img src={src} alt={alt} width={750} height={750} className='h-full w-full object-cover' />
      <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-300 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100">
        <h2 className="text-secondary text-2xl font-bold mb-4 text-center px-4">{title}</h2>
...
const InfoHome = () => {
  ...
  return (
    ...
    >
      <div className='mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-x-14 lg:gap-y-12'>
